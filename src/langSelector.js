...
export const es = {
  ...
  about: {
    ...
    description:
      'Somos una empresa de aseguramiento  marítimo dedicada a la excelencia en servicios de consultoría y formación. Fundada en 2020, MAIC ha ido ganando confianza en la industria marítima. A lo largo de los años, hemos forjado sólidas alianzas con importantes compañías navieras, terminales marítimas y fletadores, ganando una reputación de confiabilidad, integridad e innovación. <br> <br> Con un compromiso de mantenernos al tanto de las tendencias y tecnologías emergentes, MAIC continúa evolucionando, ofreciendo soluciones de vanguardia que satisfacen las cambiantes necesidades de nuestros clientes en un panorama marítimo siempre en transformación. Desde nuestra fundación hasta el día de hoy, nuestra dedicación inquebrantable a la excelencia ha permanecido como la piedra angular de nuestra misión, impulsándonos a elevar continuamente el estándar de la industria y las mejores prácticas. <br> <br> En MAIC, nos especializamos en proporcionar soluciones integrales adaptadas a las necesidades específicas de las empresas marítimas en todo el mundo. Nuestro equipo de expertos aporta un amplio conocimiento y experiencia en la industria a cada proyecto. Ya sea optimizando la eficiencia operativa, mejorando los protocolos de seguridad o promoviendo iniciativas de sostenibilidad, MAIC se compromete a ayudar a nuestros clientes a alcanzar sus objetivos. Con un enfoque en la innovación y la mejora continua, capacitamos a las organizaciones para que naveguen por las complejidades de la industria marítima con confianza y éxito. Confíe en MAIC para obtener experiencia confiable y soluciones transformadoras que impulsen su negocio hacia el éxito en las olas.',
  },

  services: {
    title: 'Explore nuestra gama de servicios',
    description:
      'Entendemos lo diversas que son las necesidades de los operadores marítimos. Por eso, ofrecemos una amplia gama de servicios diseñados para satisfacer las necesidades específicas de los operadores marítimos, garantizando la seguridad, el cumplimiento normativo y la excelencia operativa.',
  },
  consultancy: {
    title: 'Consultoría Especializada',
    description:
      'Constituye la piedra angular de nuestros servicios, brindando asesoramiento experto y orientación sobre aspectos intrincados de las operaciones marítimas. Desde el cumplimiento normativo hasta la evaluación de riesgos y la gestión de la calidad, analizamos los resultados con un profundo cononimiento sobre la industria para abordar los desafíos que enfrentan nuestros clientes, ofreciendo soluciones personalizadas para un crecimiento sostenible y optimizado .',
  ...
  training: {
    ...
    description:
      'Diseñado para dotar al personal de habilidades y conocimientos esenciales para asegurar una mejora sostenible en  performance. A través de talleres interactivos, ejercicios de simulación y sesiones de capacitación práctica, los participantes obtienen conocimientos prácticos sobre protocolos de seguridad, procedimientos de respuesta a emergencias y requisitos regulatorios, fomentando una cultura de mejora continua y cumplimiento.',
  ...
  management: {
    ...
    description:
      'Optimizar la gestión implica una combinación de estrategias dirigidas a mejorar el liderazgo, la comunicación, la organización y la eficacia general dentro de su organización. Al garantizar el alineamiento de procesos y procedimientos con las mejores prácticas y aprovechar estrategias de abajo hacia arriba, aprovechando el conocimiento colectivo y la experiencia para impulsar la innovación, mejorar los procesos y lograr un crecimiento sostenible.',
...
export const en = {
  ...
  about: {
    ...
    description:
      'We are a Marine Assurance company dedicated to excellence in consultancy and training   services. Established in 2020, MAIC has been gaining trust in the maritime industry. Over the years, we have forged strong partnerships with leading shipping companies, marine  terminals, and charterers, earning a reputation for reliability, integrity, and  innovation. <br> <br> With a commitment to staying ahead of emerging trends and technologies, MAIC continues to evolve, offering cutting-edge solutions that meet the evolving needs of our clients in an ever-changing maritime landscape. From our inception to the present day, our      unwavering dedication to excellence has remained the cornerstone of our mission, driving us to continually raise the bar for industry standards and best practices. <br> <br> At MAIC, we specialize in providing comprehensive solutions tailored to the specific needs of maritime businesses worldwide. Our team of experts brings extensive industry knowledge and experience to every project.Whether it´s optimizing operational efficiency, enhancing safety protocols, or promoting sustainability initiatives, MAIC is committed to helping our clients achieve their goals. With a focus on innovation and continuous improvement, we empower organizations to navigate the complexities of the maritime industry with confidence and success. Trust MAIC for reliable expertise and transformative solutions that propel your business forward on the waves of success.',
  },

  services: {
    title: 'Explore our core services.',
    description:
      'We understand how diverse the needs of maritime operators are. That´s why we offer a comprehensive suite of services tailored to meet the specific needs of maritime operators, ensuring safety, compliance, and operational excellence.',
  },
  consultancy: {
    title: 'Specialized Consultancy',
    description:
      'Forms the cornerstone of our solutions, providing expert advice and guidance on intricate aspects of maritime operations. From regulatory compliance to risk and quality management, we leverage the results addressing specific challenges faced by our clients, offering tailored solutions for sustainable growth and enhanced performance.',
    sub_title: 'Consultancy',
    sub_description:
      'Our specialized consultancy offers expert guidance and support to ensure the safety, compliance, and environmental performance to streamline efficiency of maritime and port operations. <br>       <br>      Our in-depth knowledge of international regulations, industry standards, and best practices are the      foundation of all our processes. We offer tailor made solutions for assessing the current situation,      identify the root cause of problems, implement the solutions and evaluate the outcomes gearing      continuous      improvement cycles, while we ensure effective, efficient and cost-effective results. <br> <br>      Depending on the customer needs we can: <br><br>      • Create a tailor-made Management Review programme. <br>      • Lead an audit based on an in-house audit scheme based on Marine Terminal Management and      Self-Assessment (MTMSA) programme. <br>      • Lead an audit based on an in-house audit scheme based on Tanker Management Self-Assessment (TMSA)      Programme. <br>      • Develop plans for improve safety, environmental or operational performance. <br>      • Evaluate the effectiveness of new projects. <br>      • Create or review business models feasibility. <br>      • Assess different technical and business aspects of maritime or terminal operations with a holistic      perspective. <br>      • Emergency preparedness and response plans. <br>      • Crisis management. <br>      • Capabilities review. <br>',
  },
  training: {
    title: 'Training Services',
    description:
      'Designed to equip personnel with essential skills and knowledge to ensure sustainable and enhaced performance. Through interactive workshops, simulation exercises, and hands-on training sessions, participants gain practical insights into safety protocols, emergency response procedures, and regulatory requirements, fostering a culture of continuous improvement and compliance.',
    sub_title: 'Training Services',
    sub_description:
      'Through interactive workshops, simulation exercises, and hands-on training sessions,       participants gain practical skills, knowledge, and confidence to effectively navigate       challenges and mitigate risks in their day-to-day operations. By investing in training       companies and organizations can enhance their safety and working culture,       improve performance, and ensure compliance with industry standards and regulations. <br> <br>      Comprehensive training services are tailored to the specific needs of shipping and terminal operators.       These training programs cover a wide range of topics essential for promoting safety, compliance, and       operational efficiency in the marine industry. <br><br>       Courses may include: <br> <br>      •	Vetting and Marine Assurance management. <br>      •	Ship shore-interface management and operations. <br>      •	Ship to ship operations. <br>      •	Risk management. <br>      •	The application of safety procedures. <br>      •	Emergency preparedness and response. <br><br>      Our courses provide participants with the advanced knowledge and skills needed to effectively lead and oversee assurance activities within maritime operations. this course equips managers with the       tools to optimize operational performance while mitigating potential risks and ensuring adherence to       industry standards. Participants learn strategic planning techniques, best practices in operational management, and methods for fostering a culture of safety and compliance within their organizations.',
  },
  management: {
    title: 'Enhancing Management',
    description:
      'Enhancing management involves a combination of strategies aimed at improving leadership, communication, organization, and overall effectiveness within your organization. By ensuring the alignment of process and procedures with the best practices and leveraging bottom-up strategies, tapping into the collective knowledge, and expertise to drive innovation, improve processes, and achieve sustainable growth.',
    sub_title: 'Enhancing Management',
    sub_description:
      'At MAIC, we specialize in providing comprehensive solutions tailored to the       specific needs of maritime businesses worldwide. <br> <br>      Our team of experts brings extensive industry knowledge and experience to every      project, providing high level of support and guidance to the top management.      Whether it is aligning processes with the best practices, optimizing operational efficiency,      enhancing safety culture, or promoting sustainability initiatives, MAIC is committed to helping      our clients to achieve their objectives. <br><br>      With a focus on innovation and continuous improvement, we empower organizations to navigate the      complexities of the maritime industry with confidence and success. Deploying our expertise and      transformative solutions that propel your business forward on the waves of success.',
  },
  contact: {
    title: 'Contact Us',
    email: 'Email',
